...
import com.example.sms.ui.InboxMessage

class senderadapter (private val context : Context, private val dataSource : ArrayList<InboxMessage>) : BaseAdapter() {
    ...
    override fun getView(position: Int, contentView: View?, parent: ViewGroup?): View {
        ...
        val sms = getItem(position) as InboxMessage
